...
const Appointment = () => {
    ...
    const bookAppointment = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendBase + '/api/user/book-appointment', { docId, slotDate, slotTime }, { headers: { token } });
    ...
    return docInfo && (
        <div>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
                ...
                <button onClick={bookAppointment} className='bg-primary text-white text-sm font-light px-14 py-3 mt-5 rounded-full'>Book an Appointment</button>
            </div>
