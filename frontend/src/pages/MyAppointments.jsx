...
const MyAppointments = () => {
  ...
  const getUserAppointments = async () => {
    try {
      ...
      const { data } = await axios.get(backendBase + '/api/user/appointments', { headers: { token } })
      if (data.success) {
  ...
  const cancelAppointment=async(appointmentId)=>{
    try {
      const { data } = await axios.post(backendBase + '/api/user/cancel-appointment',{appointmentId}, { headers: { token } })
      if (data.success) {
